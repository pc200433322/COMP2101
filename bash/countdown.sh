...
# int signal handler function
function intTrap {
sleepCount=$numberOfSleeps
echo "You cannot use interupt. Re-starting process from beginning"
}

# Quit signal handler function
function quitTrap {
echo "Exitting. Secret to get out of script is found"
sleepCount=0
stty sane
exit 0
...
# updated loop for interupt repeat
while [ $sleepCount -gt 0 ]; do 
